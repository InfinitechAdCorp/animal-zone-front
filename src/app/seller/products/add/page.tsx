      ...
      <div className="max-w-4xl mx-auto">
         <div className="mb-6 flex items-center justify-between">
          <Link href="/seller/products">
            <Button variant="ghost" className="flex items-center gap-2 text-gray-700 hover:text-green-800">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 flex items-center">
                  <span className="w-8 h-8 bg-green-800 text-white rounded-full flex items-center justify-center text-sm mr-3">1</span>
                  Basic Information
                </h2>
                <div className="grid gap-4 sm:gap-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="flex h-10 sm:h-11 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-800 focus-visible:ring-offset-2 mt-1.5"
                      >
                        ...
                        <label
                          ...
                          className={`flex items-center justify-center p-2 sm:p-3 border-2 rounded-lg cursor-pointer transition-all ${
                            form.petType.includes(type)
                              ? "border-green-800 bg-green-50 text-primary-700"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="flex w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-800 focus-visible:ring-offset-2 mt-1.5 resize-none"
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 flex items-center">
                  <span className="w-8 h-8 bg-green-800 text-white rounded-full flex items-center justify-center text-sm mr-3">2</span>
                  Pricing & Inventory
                </h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 flex items-center">
                  <span className="w-8 h-8 bg-green-800 text-white rounded-full flex items-center justify-center text-sm mr-3">3</span>
                  Product Details
                </h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 flex items-center">
                  <span className="w-8 h-8 bg-green-800 text-white rounded-full flex items-center justify-center text-sm mr-3">4</span>
                  Product Images
                </h2>
                <div>
                  ...
                  <Input
                    ...
                    className="rounded-lg mt-1.5 h-10 sm:h-11 file:mr-4 file:py-1 file:px-3 file:rounded file:border-0 file:text-sm file:bg-green-50 file:text-primary-700 hover:file:bg-green-800"
                  />
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 flex items-center">
                  <span className="w-8 h-8 bg-green-800 text-white rounded-full flex items-center justify-center text-sm mr-3">5</span>
                  Verification Documents
                </h2>
                <div className="grid gap-4">
                  <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t">
                ...
                <Button
                  ...
                  className="w-full sm:flex-1 bg-green-800 hover:bg-green-600 rounded-lg h-11 px-6 font-medium"
                >
                  Submit for Review
                </Button>
              </div>
